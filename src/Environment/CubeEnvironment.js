...
import Blue from '../Assets/Models/georgia_car.glb'
...
class CubeEnvironment extends Component {
    ...
    constructor(props) {
		...
		this.overlayItem = new OverlayItem(
			"EARFQUAKE", 
			"VIDEO", 
			"https://www.youtube.com/embed/HmAsUQEFYGI"
		)
      }
	...
	populateScene = () => {
		...
		this.addModel(Blue, new THREE.Vector3(0,0,0), this.overlayItem);
		this.setupFog();
	};
	 ...
	 */
	setupFog = () => {
		this.scene.fog = new THREE.FogExp2(new THREE.Color('white'), 0.01); // Color, Density
	};
